package com.app.service.reviewaza.chatbot
...
import com.app.service.reviewaza.chatbot.adapters.ChatAdapter
import com.app.service.reviewaza.chatbot.models.Message
import com.app.service.reviewaza.databinding.ActivityChatbotBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSend.setOnClickListener {
            ...
            if (message.isNotEmpty()) {
                ...
                Toast.makeText(this@ChatActivity, "Please enter text!", Toast.LENGTH_SHORT).show()
            }
        }
